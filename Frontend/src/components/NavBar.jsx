...
const NavBar = () => {
  ...
  return (
    <nav className="sticky w-full flex justify-between items-center p-4 bg-white shadow-sm top-0 z-50">
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-center py-4 text-sm transition-all duration-300 ease-in-out transform ${
          menuOpen
